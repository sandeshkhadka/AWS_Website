  ...
  return (
    <section>
      <div className="py-24 md:py-32">
        <div className="mx-auto flex flex-col px-6 md:grid md:max-w-7xl md:grid-cols-2 md:gap-12">
          ...
          <div className="-mx-6 px-6 [mask-image:radial-gradient(ellipse_100%_100%_at_50%_0%,#000_70%,transparent_100%)] sm:mx-auto sm:max-w-md md:-mx-6 md:ml-auto md:mr-0">
            <div className="rounded-2xl border border-neutral-400 p-3 shadow-lg md:pb-12">
...
const Integration = ({
  ...
  return (
    <div className="hover:bg-muted dark:hover:bg-muted/50 space-y-4 rounded-lg border border-neutral-500 p-4 transition-colors">
